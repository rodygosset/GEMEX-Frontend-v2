...
const MonthlyAssessmentPage: NextPage<Props> = ({ data }: Props) => {
	// state
	...
	const refreshMoisCycle = () => {
		...
		makeAPIRequest<MoisCycle, void>(session, "get", "mois_cycle", `id/${moisCycle.id}`, undefined, (res) => setMoisCycle(res.data))
	}

...
import GraphWidget from "@components/quality-module/widgets/cycle-page/graph-widget";
        ...
        <main className="flex flex-col px-[7%] gap-y-16 pt-6">
            <div className="w-full flex flex-row gap-16">
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <p className="text-md text-primary uppercase text-opacity-40 tracking-widest whitespace-nowrap">Cycle d'évaluation qualité</p>
            ...
            <div className="w-full flex flex-row gap-4">
                <div className="flex flex-col flex-1 flex-grow-[1.3] gap-4">
                    <MonthlyAssessmentsWidget />
                    <ExpositionsWidget />
                </div>
                <div className="flex flex-col gap-4 flex-1">
                    <GraphWidget cycle={data} />
                    <ThematiquesWidget />
                </div>
            </div>
        </main>

...
// this page displays information about a given Element object
...
const EditElement: NextPage<Props> = (
    {
        data
    }
) => {
    ...
    return (
        ...
        <>
            <Head>
				<title>Modifier {data.nom} (Élément)</title>
				<meta name="description" content={`Modifier l'élément ${data.nom}`} />
			</Head>
            <EditTemplate
                itemType={itemType}
                defaultValues={data}
        ...
        :
        // in case the user isn't allowed to edit the element
        user && userRole && data && !userHasRequiredPermissions() ?
...
export const getServerSideProps: GetServerSideProps<Props> = async (context) => {
    ...
    // in case the provided element_id doesn't exist in the database

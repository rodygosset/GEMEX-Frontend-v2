...
const LoginPage: NextPage = () => {
	...
	return (
		<main
			...
			<div
				className="w-full h-full sm:p-[64px] bg-[url('/images/login-bg.jpg')] bg-cover bg-center bg-no-repeat
						...
						<form
							...
							<div className="flex flex-col gap-[32px]">
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="text-white/80 text-base font-normal">Matricule</FormLabel>
											<FormControl>
												<Input
													type="password"
													{...field}

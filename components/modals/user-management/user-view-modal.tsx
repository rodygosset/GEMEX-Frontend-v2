...
const UserViewModal = ({ data, isVisible, closeModal, refresh }: UserManagementViewModalProps<User>) => {
	...
	useEffect(() => {
		...
		makeAPIRequest<UserRole, void>(session.data as MySession, "get", "roles", `id/${data.role_id}`, undefined, (res) => setRole(res.data))
	}, [data])

...
const FilePicker = ({ isVisible, isExplorer, onSelect, closeModal }: Props) => {
	...
	const isSelected = (fileName: string) => (isExplorer ? selectedFiles.includes(fileName) : selectedFiles[0] == fileName)
	...
	useEffect(() => {
		...
		makeAPIRequest<Fichier[], void>(session.data as MySession, "post", "fichiers", "search/", getSearchParams(), (res) => setFiles([...res.data]))
	...
	return (
		<ModalContainer isVisible={isVisible}>
			<section className={styles.modal}>
				{isExplorer ? <h4>Explorer les fichiers</h4> : <h4>Sélectionner un fichier</h4>}
				<SearchBar
					fullWidth
					hideCTA
					hideSelect

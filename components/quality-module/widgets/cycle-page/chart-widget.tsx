                ...
                <div className="flex flex-col items-end max-[480px]:items-start">
                    <span>
                        <b className={`text-3xl ${
                            getAverage(cycle) < 10 ? "text-error" : getAverage(cycle) < 15 ? "text-warning" : "text-success"
                        }`}>
                            { getAverage(cycle) }
                        </b> 
                    ...
                    <span className="text-end max-[480px]:text-start">
                        <b className={`text-sm ${
                            getDistanceToGoal(getAverage(cycle)) < 0 ? "text-error" : getDistanceToGoal(getAverage(cycle)) < 5 ? "text-warning" : "text-success"
                        }`}>

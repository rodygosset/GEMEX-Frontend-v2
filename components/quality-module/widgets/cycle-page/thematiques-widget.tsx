...
const ThematiquesWidget = ({ cycle }: Props) => {
	// state
	...
	useEffect(() => {
		...
		makeAPIRequest<Domaine[], void>(session, "get", "domaines", undefined, undefined, (res) =>
			setThematiques(
				res.data
					.map((d) => d.thematiques)
					.flat()
	...
	return (
		<SectionContainer>
			<div className="flex flex-col">
				...
				<p className="text-base font-normal text-blue-600/60">Prochaines thématiques à évaluer</p>
			</div>

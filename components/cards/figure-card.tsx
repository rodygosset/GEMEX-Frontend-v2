    ...
    return (
        <article className={cn(
            ...
            <div className="w-full flex items-center gap-[16px]">
                ...
                <span className="text-sm font-medium text-neutral-50/80 w-full">
                    {figureCard.title}
                </span>
                <Link 
                    className={cn(
            ...
            <div className="w-full flex flex-col">
                <span className="font-bold text-4xl text-neutral-50 leading-none">
                    {figureCard.value ?? 0}
                </span>
                <span className="text-sm font-normal text-neutral-50/60">
                    {figureCard.caption}
                </span>
            </div>
        </article>

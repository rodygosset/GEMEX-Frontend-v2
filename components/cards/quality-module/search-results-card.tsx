...
const SearchResultsCard = ({ mois_cycle_id, evaluations, onRefresh }: Props) => {
	// display info state
	...
	const getMonthAndYear = async () => {
		...
		makeAPIRequest<MoisCycle, void>(session, "get", "mois_cycle", `id/${mois_cycle_id}`, undefined, async (res) => {

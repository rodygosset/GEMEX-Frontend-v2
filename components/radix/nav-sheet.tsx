...
const NavSheet = ({ navItems }: Props) => {
	...
	return (
		<Sheet
			...
			<SheetTrigger>
				<span
					className="p-[12px] flex flex-row justify-center items-center rounded-[8px] hover:bg-blue-600/10 cursor-pointer
			...
			<SheetContent
				className="max-sm:w-full flex flex-col gap-4 bg-blue-900"
				side="left">

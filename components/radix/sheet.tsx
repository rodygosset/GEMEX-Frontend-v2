...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 shadow-lg shadow-primary/20 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-normal text-blue-600", className)}
    {...props}
  />
))

...
const alertVariants = cva(
	"relative w-full rounded-[8px] border border-blue-600/20 p-[16px] [&>svg~*]:pl-[28px] [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-[16px] [&>svg]:top-[16px] [&>svg]:text-foreground",
	{
		variants: {
			variant: {
